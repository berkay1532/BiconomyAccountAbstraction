...
import { BiconomySmartAccountV2, Transaction } from "@biconomy-devx/account";
  ...
  const createSession = async (enableSessionKeyModule: boolean) => {
    ...
    try {
      ...
      const sessionTxData = await sessionModule.createSessionData([
        {
          ...
          sessionPublicKey: `0x${sessionKeyEOA}`,
          sessionKeyData: `0x${sessionKeyData}`,
        },
      ]);
      ...
      let partialUserOp = await smartAccount.buildUserOp(
        transactionArray as Transaction[]
      );
